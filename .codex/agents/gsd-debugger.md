...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks F:/Projects/zz-video-plugins/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/Projects/zz-video-plugins/.codex/get-shit-done
                  → writes to F:/Projects/zz-video-plugins/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "F:/Projects/zz-video-plugins/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "F:/Projects/zz-video-plugins/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "F:/Projects/zz-video-plugins/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
