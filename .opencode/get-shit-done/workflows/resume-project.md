...
<required_reading>
@F:/Projects/zz-video-plugins/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "F:/Projects/zz-video-plugins/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
