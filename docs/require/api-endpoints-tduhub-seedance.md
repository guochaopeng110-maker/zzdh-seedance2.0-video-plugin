...
### 2.1 基础信息
* **Method**: `POST`
* **URL**: `https://apihub.tduvr.club/zlhub/v1/contents/generations/tasks`
* **Headers**:
...
### 3.1 基础信息
* **Method**: `GET`
* **URL**: `https://apihub.tduvr.club/zlhub/v1/contents/generations/tasks/{id}`
...
```json
{
    "created_at": 1776060103,
    "id": "task_3hbDQ8Q8fh7L3MZqNm2MVcHUE1lP5kRv",
    "status": "pending",
    "task_id": "task_3hbDQ8Q8fh7L3MZqNm2MVcHUE1lP5kRv"
}
```
